#!/usr/bin/env python3
"""
Enhanced Radio Communication - Control Device Application
--------------------------------------------------------
This application runs on the control device (PC/laptop) and:
1. Auto-discovers the remote device using mDNS
2. Displays the video stream from the remote device
3. Shows data usage statistics
4. Auto-launches in a browser
"""
